...
% Last Modified by GUIDE v2.5 03-Mar-2020 09:00:57
...
angka = str2num(input);
%state = get(handles.hasil,'string');
if mod(angka,400)==0
    state='Tahun Kabisat';
else if mod(angka,100)==0
    state='Bukan Tahun Kabisat';
else if mod(angka,4) == 0
    state='Tahun Kabisat';
else 
    state='Bukan Tahun Kabisat';
    end
...
set(handles.hasil,'string',(state));
